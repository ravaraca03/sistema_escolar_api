...
from sistema_escolar_api.views import eventos
from sistema_escolar_api.views.eventos import ResponsablesEventosView
...
urlpatterns = [
    ...
    #Responsable Eventos
        path('responsables-evento/', ResponsablesEventosView.as_view()),
    #Login
